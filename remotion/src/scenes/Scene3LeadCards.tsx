          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 16, marginBottom: 20, fontFamily: "Space Grotesk, sans-serif" }}>
                ...
                <span style={{ color: "rgba(255,255,255,0.4)", fontSize: 14 }}>{lead.reviews} تقييم</span>
              </div>
              <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
                <span style={{ fontSize: 13, color: "#ef4444", backgroundColor: "rgba(239,68,68,0.12)", padding: "4px 12px", borderRadius: 8, fontFamily: "Space Grotesk, sans-serif" }}>❌ بدون موقع</span>
                <span style={{ fontSize: 13, color: "#22c55e", backgroundColor: "rgba(34,197,94,0.12)", padding: "4px 12px", borderRadius: 8, fontFamily: "Space Grotesk, sans-serif" }}>📱 يوجد رقم</span>
              </div>
              {frame > 40 + i * 12 && (
                <div
                  style={{
