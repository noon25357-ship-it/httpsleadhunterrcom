    ...
    <AbsoluteFill>
          ...
          >
            ...
            <div
              style={{
                ...
                top: -20,
                left: -20,
                transform: `scale(${interpolate(Math.max(frame - i * 8 - 10, 0) % 30, [0, 30], [0.5, 2])})`,
                opacity: interpolate(Math.max(frame - i * 8 - 10, 0) % 30, [0, 15, 30], [0.6, 0.3, 0]),
              }}
            />
            {/* Pin */}
            <div
      ...
      <Sequence from={30}>
        ...
        >
          ...
          <span style={{ fontSize: 22, color: "rgba(255,255,255,0.5)" }}>leads found</span>
        </div>
      </Sequence>
    </AbsoluteFill>
  );
