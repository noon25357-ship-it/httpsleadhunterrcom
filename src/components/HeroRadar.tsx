...
const HeroRadar = () => {
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
      <div className="relative w-[280px] h-[280px] sm:w-[420px] sm:h-[420px] md:w-[580px] md:h-[580px] lg:w-[680px] lg:h-[680px]">
        
        {/* Ambient glow behind radar */}
        <div className="absolute inset-[15%] rounded-full bg-primary/[0.06] blur-[60px] md:blur-[80px]" />
        ...
        {/* Detected blips - hidden on very small screens for performance */}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative">
            <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-primary/30 shadow-[0_0_15px_hsl(145_80%_42%/0.4),0_0_40px_hsl(145_80%_42%/0.15)]" />
            <motion.div
