    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4" dir="rtl">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black text-foreground mb-2">إنشاء حساب مجاني</h1>
          <p className="text-sm text-muted-foreground">جرّب أداة البحث عن العملاء مجانًا</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4 bg-card border border-border rounded-2xl p-6">
          ...
          >
            {loading ? "جاري التسجيل..." : "ابدأ مجانًا 🚀"}
          </button>
        </form>
